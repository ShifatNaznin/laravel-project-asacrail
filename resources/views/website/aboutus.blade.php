    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="header-page-locator">
          <ul>
            <li><a href="#">Home /</a> Who We Are</li>
          </ul>
        </div>
      </div>
    </div>
...
<div class="blog-page-area pt-100 pb-100 bg-light">
  <div class="container">
    <div class="row">
      <div class="col-lg-9 col-md-9 col-sm-12 mb-sm-30">
        <div class="row">
          ...
          <div class="col-12">
            ...
            @php
            $head =App\AboutHeading::orderBy('id', 'DESC')->get();
       @endphp
       ...
       @endforeach
            <div id="search_result">
              ...
              <div class="row">
                {{-- @php
                $project =App\AboutUs::where('id' 1)->get();
           @endphp --}}
           ...
           {{-- @foreach ($head as $data) --}}
                  ...
                  <div class="single-blog-slide">
                    <div class="images">
                      ...
                      <div class="overley">
                        <ul>
                          <li>
                            <a href="{{url('/aboutus-view-one')}}"><i class="fa fa-eye"></i></a>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div class="blog-informations">
                      <div class="blog-details">
                        <h3><a href="{{url('/aboutus-view-one')}}">{{$data->title}}</a></h3>
                        <p>
                          {!!Str::words($data->description,10)!!}
                        </p>
                        <div class="read-more">
                          <a href="{{url('/aboutus-view-one')}}">Read More</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="single-blog-slide">
                    <div class="images">
                      ...
                      <div class="overley">
                        <ul>
                          <li>
                            <a href="{{url('/aboutus-view-two')}}"><i class="fa fa-eye"></i></a>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div class="blog-informations">
                      <div class="blog-details">
                        <h3><a href="{{url('/aboutus-view-two')}}">{{$data->title}}</a></h3>
                        <p>
                          {!!Str::words($data->description,10)!!}
                        </p>
                        <div class="read-more">
                          <a href="{{url('/aboutus-view-two')}}">Read More</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                @endforeach
                {{-- @php
                $project =App\AboutUs::where('id' 2)->get();
           @endphp
                  ...
                  <div class="single-blog-slide">
                    <div class="images">
                      ...
                      <div class="overley">
                        <ul>
                          <li>
                            <a href="{{url('/aboutus-view',$data->id)}}"><i class="fa fa-eye"></i></a>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div class="blog-informations">
                      <div class="blog-details">
                        <h3><a href="{{url('/aboutus-view',$data->id)}}">{{$data->title}}</a></h3>
                        <p>
                          {!!Str::words($data->description,10)!!}
                        </p>
                        <div class="read-more">
                          <a href="{{url('/aboutus-view',$data->id)}}">Read More</a>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-12">
        <form style="" id="search_box" action="{{route('search_aboutus') }}" method="Post">
          @csrf
          ...
          $(document).ready(function(){
              ...
              function search_init() {
                  $('#search_box').off().keyup(debounce(function (e) {
                      ...
                      axios.post('/aboutus-immediate', formdata)
