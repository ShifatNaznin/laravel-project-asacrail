    ...
    <div class="row fullwidth-photocontst">
      <div class="col-sm-12">
        ...
        <div class="single-content-details">
          ...
          <h3 class="headding-title">{{$data->title}}</h3>
          <ul id="meta-text">
            <li class="date"><i class="fa fa-camera"></i><span>Photo Credit:</span> {{$data->photo_credit}}</li>
          ...
          <div class="blog-content-share-social-icons">
            ...
            <ul>
              <li> <span style="margin: 0px 0px 0px 0px;">Share: </span> </li>
              <li><iframe
                  src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Fasacrail.com%2Faboutus-view%2F1&layout=button_count&size=large&width=88&height=28&appId"
