  ...
  <div class="container">
    <div class="row">
                  ...
                  <div class="single-blog-slide">
                    ...
                    <div class="blog-informations">
                      <div class="blog-details">
                        <h3><a href="{{url('/sectors-view',$data->id)}}">{{$data->title}}</a></h3>
                        <p>
      ...
      <div class="col-lg-3 col-md-3 col-sm-12">
        <form style="" id="search_box" action="{{ route('search_sectors') }}" method="Post">
          @csrf
          ...
          $(document).ready(function(){
              ...
              function search_init() {
                  $('#search_box').off().keyup(debounce(function (e) {
                      ...
                      axios.post('/sectors-immediate', formdata)
