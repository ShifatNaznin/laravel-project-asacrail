      ...
      <div class="card">
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Update Content</h3>
            </div>
        ...
        <div class="card-body">
          ...
          <script>
            swal({
                            title: "Successfully!",
                            text: "registered user information.",
                            timer: 5000,
                            icon: "success",
                        });
          ...
          <div class="form-group row custom_form">
            ...
            <div class="col-sm-7">
              <textarea id="my-editor" name="product_long_description" class="form-control">shsjskksks</textarea>
          ...
          <div class="form-group row custom_form">
            ...
            <div class="col-sm-7">
              <input type="file" id="input-file-now-custom-1" name="product_image1" class="dropify" />
