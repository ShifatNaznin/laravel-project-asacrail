...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{route('sectors_update')}}" enctype="multipart/form-data">
      @csrf
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group row custom_form{{$errors->has('photo_credit')? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" name="photo_credit" value="{{$news->photo_credit}}">
          ...
          <div class="form-group row custom_form">
            ...
            <div class="col-sm-7">
              ...
              <div class="row">
                ...
                <div class="col-4">
                  <img src="{{asset('uploads/sectors/'.$news->photo)}}" style="width: 182px;" alt="">
                </div>
              </div>
            </div>
          </div>
