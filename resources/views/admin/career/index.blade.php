            ...
            <div class="card-header header-part">
                <div class="row">
                    <div class="col-md-6 card_header_title">
                        <h3><i class="fa fa-gg-circle"></i> All Career Message</h3>
                    </div>
                    <div class="col-md-6 text-right card_header_btn">
                        {{-- <a href="{{route('contact_address_add')}}" class="btn"><i class="fa fa-plus-circle"></i>
                        Add
                        Contact Address</a> --}}
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm btn-color-ceate">
                                    <a href="/file/{{$data->id}}" class="btn btn-warning" target="_blank">View</a>
                                    <a href="/file/download/{{$data->file}}"
                            ...
                            <td>
                                <div class="btn-group btn-group-sm btn-color-ceate">
                                    <a href="{{route('career_view',$data->id)}}" class="btn btn-info view-btn">View</a>
                                    {{-- <a href="{{route('contact_address_edit',$data->id)}}"
...
<div class="modal fade" id="softDelModal" tabindex="-1" role="dialog" aria-labelledby="SoftDelModalTitle"
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <form method="post" action="{{route('career_delete')}}">
            @csrf
