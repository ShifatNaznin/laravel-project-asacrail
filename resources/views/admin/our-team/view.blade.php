            ...
            <div class="card-header header-part">
                <div class="row">
                    <div class="col-md-6 card_header_title">
                        <h3><i class="fa fa-gg-circle"></i> View Our Team</h3>
                    </div>
                    <div class="col-md-6 text-right card_header_btn">
                        <a href="{{route('our_team')}}" class="btn"><i class="fa fa-reply"
                                aria-hidden="true"></i>
                            Back</a>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 offset-xlg-1">
                        <img style="width:200px" src="{{asset('uploads/article-blog/'.$data->photo)}}"
                            alt="photo" />
                    </div>
                    <div class="col-md-6">
