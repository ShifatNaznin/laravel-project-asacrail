...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{route('our_team_update')}}" enctype="multipart/form-data">
      @csrf
      ...
      <div class="card">
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Update Our Team</h3>
            </div>
        ...
        <div class="card-body">
          ...
          <div class="form-group row custom_form">
            ...
            <div class="col-sm-7">
              <textarea id="my-editor" name="summary"
                class="form-control">{!! $data->summary !!}</textarea>
          ...
          <div class="form-group row custom_form">
            ...
            <div class="col-sm-7">
              <div class="row">
                ...
                <div class="col-4">
                  <img src="{{asset('uploads/article-blog/'.$data->photo)}}" style="width: 182px;" alt="">
                </div>
              </div>
            </div>
          </div>
