...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{url('admin/article-blog/update')}}" enctype="multipart/form-data">
      @csrf
      ...
      <div class="card">
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Update Services</h3>
            </div>
            <div class="col-md-6 text-right card_header_btn">
              <a href="{{url('admin/article-blog')}}" class="btn"><i class="fa fa-reply" aria-hidden="true"></i>
                Back</a>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <div class="form-group row custom_form">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" name="title" value="{{$article->article_title}}">
            </div>
          </div>
          <div class="form-group row custom_form">
          ...
          <div class="form-group row custom_form{{$errors->has('photo_credit')? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" name="photo_credit" value="{{$article->photo_credit}}">
          ...
          <div class="form-group row custom_form">
            ...
            <div class="col-sm-7">
              <div class="row">
                ...
                <div class="col-4">
                  <img src="{{asset('uploads/article-blog/'.$article->article_photo)}}" style="width: 182px;" alt="">
                </div>
              </div>
            </div>
          </div>
