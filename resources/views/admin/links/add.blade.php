...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{route('footer_left_store')}}" enctype="multipart/form-data">
      @csrf
      <div class="card">
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Add Social Link</h3>
            </div>
        ...
        <div class="card-body">
          ...
          {{-- <div class="form-group row custom_form{{$errors->has('heading')? ' has-error':''}}">
            <label class="col-sm-3 col-form-label">Social Link Heading:</label>
            <div class="col-sm-7">
              <textarea id="my-editor" name="heading" class="form-control" value="{{old('heading')}}"></textarea>
          ...
          <div class="form-group row custom_form{{$errors->has('instagram_link')? ' has-error':''}}">
            <label class="col-sm-3 col-form-label">Linkedin Links:</label>
            <div class="col-sm-7">
          ...
          {{-- <div class="form-group row custom_form{{$errors->has('pinterest_link')? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" name="pinterest_link" value="{{old('pinterest_link')}}">
