...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{route('project_head_update')}}" enctype="multipart/form-data">
      @csrf
        ...
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Update Project Description</h3>
            </div>
            <div class="col-md-6 text-right card_header_btn">
              <a href="{{route('project_head')}}" class="btn"><i class="fa fa-reply" aria-hidden="true"></i>
                Back</a>
            </div>
          </div>
        </div>
