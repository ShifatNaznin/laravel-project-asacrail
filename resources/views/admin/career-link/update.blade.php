...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{route('career_link_update')}}" enctype="multipart/form-data">
      @csrf
      ...
      <div class="card">
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Update Career Link</h3>
            </div>
            <div class="col-md-6 text-right card_header_btn">
              <a href="{{route('career_link')}}" class="btn"><i class="fa fa-reply" aria-hidden="true"></i>
                Back</a>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <div class="form-group row custom_form{{$errors->has('heading')? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              <textarea id="my-editor" name="heading" class="form-control">{{$project->heading}}</textarea>
          ...
          <div class="form-group row custom_form">
            <label class="col-sm-3 col-form-label">Career Link:</label>
            <div class="col-sm-7">
