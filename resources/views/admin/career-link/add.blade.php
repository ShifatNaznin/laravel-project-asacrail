...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="{{route('career_link_store')}}" enctype="multipart/form-data">
      @csrf
      <div class="card">
        <div class="card-header header-part">
          <div class="row">
            <div class="col-md-6 card_header_title">
              <h3><i class="fa fa-gg-circle"></i> Add Career Heading & Link</h3>
            </div>
        ...
        <div class="card-body">
          ...
          <div class="form-group row custom_form{{$errors->has('heading')? ' has-error':''}}">
            ...
            <div class="col-sm-7">
              <textarea id="my-editor" name="heading" class="form-control"></textarea>
